...
EXAMPLE = {
    "C1": "1 分 —— Agenda 的题目和过渡页、正文页的标题对不上，是作者把故事另写了一遍；或者标题连读没有叙事线（是什么→为什么→怎么做→价值）。3 分 —— 第一页给了结论，但摘要五条、正文三节，对不上。",
    "C2": "2 分 —— 抄下来的十四条里有五条是“XX 概览”，连读像目录不像论证。",
    "C3": "2 分 —— 每页一个论点成立，但论点只复述机制、没有业务价值判断，读起来没有专业冲击力。",
    "C4": "2 分 —— 挑的三个数字里，两个的来源行只写了“分析”。",
    "C5": "5 分 —— 该有的都在；最后一页讲的是下一步谁做，不是把前面重说一遍。",
    "C6": "1 分 —— 读完无感：没有一页留下让客户记住的要点、想尝试的冲动，或者行动写了步骤而谁做、何时做一个都没有。对外材料在这一条上失败就是失败，不是扣一分。",
    "C7": "4 分 —— 五页里四页一分钟内读完，第 11 页太密。",
    "C8": "1 分 —— 图承载了词但没有承载本页的数字（没有把数字和矢量图结合就没有洞察），或者图看着像图标、摆着而没有承载本页的话；图名两行长，不是给人看的用词。",
}
...
WORDING = {
    ...
    ("C8", "④"): "图库形状是被“组合”过的，不是直接摆上去的：它承载了本页自己的文字和数字，而且字是贴着图形放的，不是摆在旁边",
    ("C8", "⑤"): "页面上的图片是证据，不是气氛：它经过品牌配色处理，而且不是握手、玻璃大楼、围着笔记本的团队这类放到任何一份文档里都成立的图",
